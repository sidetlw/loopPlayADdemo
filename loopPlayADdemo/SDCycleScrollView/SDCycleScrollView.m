...
- (void)layoutSubviews
{
    ...
    else if (self.pageControlAliment == SDCycleScrollViewPageContolAlimentLeft) {
        x = 10;
    }
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!self.onlyDisplayText && [self.imagePathsGroup[itemIndex] isKindOfClass:[NSString class]]) {
        NSString *imagePath = self.imagePathsGroup[itemIndex];
    ...
    } else if (!self.onlyDisplayText && [self.imagePathsGroup[itemIndex] isKindOfClass:[UIImage class]]) {
        UIImage *imagePath = self.imagePathsGroup[itemIndex];
